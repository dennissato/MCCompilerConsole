...
namespace MCCompilerConsole.Converter
{
    class Generic
    {
        ...
        static private readonly NodeKind[] ARG_INT_INT_INT = { NodeKind.INTEGER, NodeKind.INTEGER, NodeKind.INTEGER };
        ...
        static private readonly VariableKind[] ARG_CONFIREMMANA = {
